  ...
  implements Comparable<l<T>>
{
  ...
  private byte[] a(Map<String, String> paramMap, String paramString)
  {
    ...
    catch (java.io.UnsupportedEncodingException paramMap)
    {
  ...
  void b(String paramString)
  {
    ...
    if (t.a.a)
    {
      ...
      if (Looper.myLooper() != Looper.getMainLooper())
        new Handler(Looper.getMainLooper()).post(new Runnable(paramString, l1)
        {
          public void run()
          {
            l.b(l.this).a(this.a, this.b);
 ...
 * Qualified Name:     org.vidogram.messenger.g.l
