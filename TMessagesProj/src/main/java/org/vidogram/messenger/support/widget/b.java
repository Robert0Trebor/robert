...
class b
{
  ...
  View a(int paramInt1, int paramInt2)
  {
    ...
    while (i < j)
    {
      ...
      RecyclerView.u localu = this.a.b(localView);
      if ((localu.d() == paramInt1) && (!localu.n()) && (!localu.q()) && ((paramInt2 == -1) || (localu.h() == paramInt2)))
        return localView;
      i += 1;
    }
    return null;
 ...
 * Qualified Name:     org.vidogram.messenger.support.widget.b
