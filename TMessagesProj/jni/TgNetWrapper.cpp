...
static const char *FileLoadOperationClassPathName = "org/vidogram/tgnet/FileLoadOperation";
...
static const char *NativeByteBufferClassPathName = "org/vidogram/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "org/vidogram/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_sendRequest", "(ILorg/vidogram/tgnet/RequestDelegateInternal;Lorg/vidogram/tgnet/QuickAckDelegate;IIIZI)V", (void *) sendRequest},
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestDelegateInternal = (jclass) env->NewGlobalRef(env->FindClass("org/vidogram/tgnet/RequestDelegateInternal"));
    ...
    jclass_QuickAckDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/vidogram/tgnet/QuickAckDelegate"));
    if (jclass_RequestDelegateInternal == 0) {
        return JNI_FALSE;
    }
    ...
    jclass_FileLoadOperationDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/vidogram/tgnet/FileLoadOperationDelegate"));
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("org/vidogram/tgnet/ConnectionsManager"));
