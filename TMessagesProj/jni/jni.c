...
JNIEXPORT void Java_org_vidogram_messenger_Utilities_aesIgeEncryption(JNIEnv *env, jclass class, jobject buffer, jbyteArray key, jbyteArray iv, jboolean encrypt, int offset, int length) {
...
JNIEXPORT jstring Java_org_vidogram_messenger_Utilities_readlink(JNIEnv *env, jclass class, jstring path) {
